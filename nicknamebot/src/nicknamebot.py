#! python3
"""Current issues: flair colors are not being randomized
"""
...
while True:
    ...
    last_user = [current_db[-1][0]]
    last_nickname = [current_db[-1][1]]
    ...
    # for now, not executing the command to update the post because the old version is still running
